...
public class PlayerInteraction : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            // Try to find PlayerEmpty (physics root), not PlayerQuad (visual)
            var playerEmpty = GameObject.Find("PlayerEmpty");
            if (playerEmpty != null)
            {
                interactionOrigin = playerEmpty.transform;
                Debug.Log("PlayerInteraction: Set interactionOrigin to PlayerEmpty");
            }
            else
            {
                interactionOrigin = transform;
                Debug.LogWarning("PlayerInteraction: PlayerEmpty not found, using transform");
            }
        }
    }
